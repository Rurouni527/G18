...
const ListProd = () => {
    return ( <
        ...
        to = { '/edit/:id?' } > G18 - 1 < /Link>< /td > < td > Product A < /td > < td > 80.000 < /td > < td > Disponible < /td > < /
        tr > <
        tr >
        <
        td > < Link className = { 'idCodeProd' }
        to = { '/edit/:id?' } > G18 - 2 < /Link>< /td > < td > Product B < /td > < td > 120.000 < /td > < td > Disponible < /td > < /
        tr > <
        tr >
        <
        td > < Link className = { 'idCodeProd' }
        to = { '/edit/:id?' } > G18 - 3 < /Link>< /td > < td > Product C < /td > < td > 75.000 < /td > < td > Disponible < /td > < /
        tr > <
        tr >
        <
        td > < Link className = { 'idCodeProd' }
        to = { '/edit/:id?' } > G18 - 4 < /Link>< /td > < td > Product D < /td > < td > 50.000 < /td > < td > No disponible < /td > < /
        tr > < /
        table > <
        /form>
    )
